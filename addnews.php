...
$news = mysqli_query($link, "SELECT * FROM `news` WHERE `id` = '{$_GET['id']}'");
...
<!--  <a href="#" class="icons-btn d-inline-block js-search-open"><span class="icon-search"></span></a>-->
    ...
    <div class="border text-center"><img class="img-fluid p-5" src="images/stock.jpg" alt="Image" /></div>
    </div>
    <div class="col-md-6">
    <h2 class="text-black"><?= $new['id_users']?>Снижение цен до  10%</h2>
    <p><?=$new['text']?>ТЕКСТ АКЦИИЯ ТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯТЕКСТ АКЦИИЯ</p>
    <div class="mb-5">
</div>
</div>
</div>
