...
<marquee behavior="alternate" bgcolor="#60bef1" direction="right" style="color: #fff; font-size: 30px; font-weight: bold; line-height: 150%; text-shadow: #000000 0px 1px 1px;">ДОБРО ПОЖАЛОВАТЬ</marquee>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <p>
                <a style=" margin-top:-300px; bottom:30px; center:50px" href="shop.php"  class="btn btn-primary px-5 py-3">Магазин</a>
              </p>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            ...
            <h3 class="text-dark"><a href="index.php">КАРДИОМАГНИЛ</a></h3>
            <p class="price">155.00₽</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="index.php"> <img src="images/product12.png" alt="Image"></a>
            <h3 class="text-dark"><a href="index.php">АФОБАЗОЛ</a></h3>
            <p class="price">170.00₽</p>
          </div>
          <div class="col-sm-6 col-lg-4 text-center item mb-4">
            <a href="index.php"> <img src="images/product12.png" alt="Image"></a>
            <h3 class="text-dark"><a href="index.php">НАЙЗ</a></h3>
